      ...
      <div class="modal-content" @click.stop>
        ...
        <div class="modal-body">
          <div class="form-grid">
            ...
            <div class="form-item">
              <label>选择平台</label>
              <select v-model="addUserForm.platformId">
      ...
      <div class="modal-content" @click.stop>
        ...
        <div class="modal-body">
          <div class="form-grid">
            ...
            <div class="form-item">
              <label>选择平台</label>
              <select v-model="editUserForm.platformId" :disabled="!isPlatformAdmin">
                <option value="">请选择平台</option>
                <option v-for="platform in platforms" :key="platform.id" :value="platform.id">
                  {{ platform.name }}
                </option>
          ...
          <div class="form-grid">
            ...
            <div class="form-item full-width">
              ...
              <div class="permission-list">
                <div v-for="page in pages" :key="page.id" class="permission-item">
            ...
            <div class="form-item full-width">
              ...
              <div class="expiry-time-container">
                ...
                <div class="permanent-checkbox">
                  <input type="checkbox" id="add-permanent" v-model="addPlatformForm.isPermanent" />
                  <label for="add-permanent">永久</label>
                </div>
              </div>
            </div>
            <div class="form-item full-width">
          ...
          <div class="form-grid">
            <div class="form-item full-width">
              ...
              <div class="expiry-time-container">
                ...
                />
                <div class="permanent-checkbox">
                  <input type="checkbox" id="permanent" v-model="renewPlatformForm.isPermanent" />
